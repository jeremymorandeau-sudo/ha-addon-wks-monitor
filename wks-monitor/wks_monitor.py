#!/usr/bin/env python3
"""
WKS Monitor v4.2.0 - Version avec interrogation firmware
...
def main():
    ...
    enable_firmware_query = bool(opt.get("enable_firmware_query", True))  # Nouvelle option
    ...
    log(f"[BOOT] 🚀 WKS Monitor v4.2.0 - Polling {poll_interval}s")
